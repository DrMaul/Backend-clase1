...
export class CustomRouter{
    ...
    get(ruta,permisos, ...funciones){ //los ... son aqui el rest
        this.router.get(ruta, this.respuestaPersonalizadas,this.accesos(permisos),...this.manejaFunciones(funciones)) //los ... son el spread
    }

    post(ruta,permisos, ...funciones){ //los ... son aqui el rest
        this.router.post(ruta, this.respuestaPersonalizadas,this.accesos(permisos),...this.manejaFunciones(funciones)) //los ... son el spread
    }
