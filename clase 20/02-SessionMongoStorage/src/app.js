...
app.use(sessions({
    ...
    store: MongoStore.create({
        ttl:3600, 
        mongoUrl: "mongodb+srv://agusfmartinez:CoderCoder@cluster0.zvgrerx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&dbName=clase20"
    })
}))
...
app.get('/login',(req,res)=>{
    ...
    if(!usuario || !password){
        res.setHeader('Content-Type','application/json');
        return res.status(400).json({error:`Completar datos de login`})
    }
