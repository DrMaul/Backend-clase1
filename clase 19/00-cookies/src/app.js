...
app.get('/setcookies',(req,res)=>{
    ...
    res.cookie("cookie3 con vto", datos, {maxAge:1000*5})
    res.cookie("cookie4 con vto", datos, {expires:new Date(2024,4,25)})
    res.cookie("cookie5 con vto y firmada", datos, {signed: true, expires:new Date(2024,4,25)})
