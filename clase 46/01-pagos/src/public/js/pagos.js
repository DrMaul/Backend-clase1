...
//1-conectar a plataforma stripe
const stripe = Stripe("tokendestripe")
let elements
...
const cargarMedios = async ()=>{
    ...
    //2- solicitar al backend generar un payment intent
    ...
    //5- generar el "elements" con medios de pago para completar
...
const mostrarResultado = async(clientSecret)=>{
    //7- verificar estado del pago y mostrarlo
